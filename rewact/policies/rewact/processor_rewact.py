...
def make_rewact_pre_post_processors(
    config: RewACTConfig,
    ...
    """Creates the pre- and post-processing pipelines for the RewACT policy.
    ...
    Args:
        config (RewACTConfig): The RewACT policy configuration object.
