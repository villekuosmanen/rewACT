...
from rewact.policies.utils import create_batch_to_transition
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if isinstance(policy_cfg, RewACTConfig):
        from rewact.policies.rewact.processor_rewact import make_rewact_pre_post_processors
    ...
    elif isinstance(policy_cfg, ACTvantageConfig):
        from rewact.policies.actvantage.processor_actvantage import make_actvantage_pre_post_processors
